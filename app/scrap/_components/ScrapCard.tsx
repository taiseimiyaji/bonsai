...
export default function ScrapCard({ title, description, imageSrc, category, timeAgo }: ScrapCardProps) {
    return (
        <Link className="bg-white dark:bg-gray-900 rounded-lg shadow-md hover:shadow-lg transition-transform transform hover:-translate-y-1 hover:scale-105" href="#">
